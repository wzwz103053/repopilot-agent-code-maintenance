...
def main() -> None:
    print_section("RepoPilot Final Demo: Docs Update Auto Approve")
    ...
    config = {
        "configurable": {
            "thread_id": "repopilot-final-docs-update-demo",
        }
    }
    ...
    print_section("Docs Target Files")
    for file in result.get("docs_target_files", []):
        print("-", file)
